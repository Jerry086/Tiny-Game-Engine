...
void Engine::Start(){
    ...
    GameObject tileMapObject("tilemap");
    gameObject.AddSpriteComponent2D("./images/sprite.bmp", renderer);
    gameObject.SetPosition(128,508);
    gameObject.AddTileMapComponent("./images/Tiles1.bmp",8,8,64,64,20,11, renderer);
